"""Regression checks for the cobalt-model-forecast-probe casebook."""
...
from casebook.harness import assert_expected, cobalt_model_forecast_probe_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(cobalt_model_forecast_probe_summary(), assert_expected())
